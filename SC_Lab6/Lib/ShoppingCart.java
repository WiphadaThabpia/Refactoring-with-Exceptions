...
public class ShoppingCart {
    ...
    public void addItem(String productId, int quantity) throws ProductNotFoundException {
        ...
        // findByID จะโยน Exeption เองถ้าไม่เจอสินค้า
     ...
     * @throws InvalidOperationException หากไม่พบสินค้า
     * @throws IllegalAccessException 
     */
    public void removeItem(String productId) throws InvalidOperationException, IllegalAccessException {
        if (productId == null) {
        ...
        else if (itemToRemove == null) {  //ถ้าวนลูปจนจบแล้วยังไม่เจอ ให้โยน Exception
